    ...
    static class Chrome
    {
        ...
        public static void Installing()
        {
            ...
            using (WebClient client = new WebClient())
            {
                ...
                string url = "https://github.com/DeniedAccessLife/MathGPTProGenerator/raw/main/MathGPTProGenerator/MathGPTProGenerator/bin/Release/";
        ...
        public static async Task Start()
        {
            ...
            if (!string.IsNullOrEmpty(url))
            {
                ...
                Input(driver, By.Id("input-firstName"), "Illusion");
                Thread.Sleep(500);
                Input(driver, By.Id("input-lastName"), "Illusion");
                Thread.Sleep(500);
